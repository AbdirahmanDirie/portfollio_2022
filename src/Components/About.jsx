        ...
        <div className="grid lg:grid-cols-2 justify-between items-center px-5">
            ...
            <div className='flex justify-center items-center sm:mt-12 mt-10' >
              ...
              <div className='items-center flex xl:items-start 2xl:items-start lg:items-start flex-col mt-10 mx-7 py-3'>
                <h1 className='text-[#F20774] text-2xl font-bold uppercase tracking-widest'>About me</h1>
                <p className='text-sm capitalize mt-4 mb-1 md:text-md lg:text-2xl 2xl:text-2xl tracking-wider'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, incidunt molestias hic doloremque facilis illum, laudantium distinctio quibusdam neque placeat animi, maxime libero sequi magnam quidem at architecto ipsum? Sunt..</p>
